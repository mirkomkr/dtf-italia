      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Badge */}
            <div className="inline-block px-4 py-1.5 mb-6 rounded-full bg-amber-500/20 border border-amber-300/30 text-amber-200 text-sm font-semibold backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a
                ...
                className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 text-base font-semibold text-amber-700 transition-all duration-200 hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-600 focus-visible:ring-offset-2"
              >
                Scopri i Modelli
              </a>
              ...
              <a
                ...
                className="inline-flex items-center justify-center rounded-lg border border-white/70 px-6 py-3 text-base font-semibold text-white transition-all duration-200 hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-600 focus-visible:ring-offset-2"
              >
                Richiedi Preventivo
              </a>
            </div>
          ...
          <div className="flex-1 hidden lg:flex items-center justify-center">
            ...
            */}
            <div 
              className="w-full max-w-md aspect-[4/3] rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm flex items-center justify-center"
              aria-hidden="true"
            >
