...
export const metadata = {
  ...
  description:
    "Stampa pellicole serigrafiche ad alta definizione per laboratori. Dmax > 4.0, nero coprente e stabilità dimensionale. Spedizioni rapide in tutta Italia.",
  keywords:
    "pellicole serigrafia, pellicole inkjet, pellicole laser, Dmax 4.0, laboratorio serigrafia Roma",
  ...
  openGraph: {
    title: "Pellicole Serigrafiche Professionali Roma",
    description:
      "Servizio di stampa pellicole ad alta definizione per laboratori serigrafici.",
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 pt-4 pb-2">
        <Breadcrumb items={BREADCRUMB_ITEMS["/pellicole-serigrafia"]} />
      </div>
      ...
      <main className="bg-gray-100 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600">
            Esplora la nostra gamma di supporti per serigrafia a Roma.
          </p>
        </div>
      </main>

      <HowItWorks
        steps={pellicoleSteps}
        sectionTitle="Precisione micrometrica: dalla tua grafica alla pellicola"
      />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                ...
                <ul className="space-y-2 text-gray-700 list-disc list-inside">
                  <li>
                    <strong>Inkjet</strong>: alta densità ottica Dmax &gt;4.0
                  </li>
                  <li>
                    <strong>Laser</strong>: compatibilità universale stampanti
                  </li>
                  <li>
                    <strong>Formato A3+</strong>: fino a 33x48 cm
                  </li>
                  <li>
                    <strong>Stabilità dimensionale</strong>: zero deformazioni
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                ...
                <ul className="space-y-2 text-gray-700 list-disc list-inside">
                  <li>
                    <strong>Serigrafia tessile</strong>: abbigliamento e gadget
                  </li>
                  <li>
                    <strong>Serigrafia industriale</strong>: cartelli, insegne
                  </li>
                  <li>
                    <strong>Circuiti stampati</strong>: elettronica
                  </li>
                  <li>
                    <strong>Vetro e ceramica</strong>: decorazioni artistiche
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <p className="mt-6 text-gray-700">
                ...
                Le nostre pellicole garantiscono uno stop perfetto alla luce UV,
                essenziale per l'incisione di telai serigrafici. Nero coprente
                al 100%, nessuna velatura, stabilità dimensionale garantita.
                Ideali per laboratori professionali a Roma che richiedono
                precisione assoluta e risultati ripetibili.
              </p>
            </div>
          </div>
        </div>
      ...
      <Benefits
        benefits={pellicoleBenefits}
        sectionTitle="Pellicole Inkjet ad alta densità: lo standard per i laboratori romani"
      />
      ...
      <FAQ
        faqs={pellicoleFaqs}
        sectionTitle="Dettagli tecnici sulle nostre pellicole professionali"
      />
    </>
  );
}
