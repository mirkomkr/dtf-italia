      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium break-words">
              Stampa di alta qualità per promuovere il tuo brand ogni giorno
              dell'anno con grafiche nitide e finiture professionali.
            </p>
          ...
          >
             ...
             * non appena l'asset è disponibile in /public/images/hero-calendari.webp
             *
             ...
             *
             * <Image
             *   src="/images/hero-calendari.webp"
             *   alt="Calendari personalizzati 2026 da muro e da scrivania per aziende - DTF Italia Roma"
             *   width={800}
             *   height={600}
             *   priority
             *   quality={85}
