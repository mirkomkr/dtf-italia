...
export const metadata = {
  ...
  description:
    "Creazione calendari personalizzati (1-1000+ pz) per privati e aziende. Alta qualità di stampa e spedizione rapida in tutta Italia.",
  keywords:
    "calendari personalizzati, calendari aziendali, calendari 2026, stampa calendari Roma",
  ...
  openGraph: {
    title: "Stampa Calendari Personalizzati 2026 Roma",
    description:
      "Creazione calendari personalizzati da 1 a 1000+ pezzi per privati e aziende.",
...
export default function CalendariPage() {
  ...
  const serviceSchema = {
    ...
    description:
      "Creazione calendari personalizzati da 1 a 1000+ pezzi. Soluzioni per privati (foto di famiglia) e aziende (eventi e promozione).",
    provider: {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 pt-4 pb-2">
        <Breadcrumb items={BREADCRUMB_ITEMS["/stampa-calendari"]} />
      </div>
      ...
      <main id="prodotti-calendari" className="bg-gray-100 py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            I Nostri Modelli 2026
          </h2>
          <p className="text-gray-600">
            Stiamo preparando il catalogo completo dei calendari 2026 a Roma.
          </p>
        </div>
      </main>

      <HowItWorks
        steps={calendariSteps}
        sectionTitle="Pianifica il tuo successo: come creiamo i tuoi calendari"
      />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100">
                ...
                <ul className="space-y-2 text-gray-700 list-disc list-inside">
                  <li>
                    <strong>Olandese da muro</strong>: formato classico 29x47 cm
                  </li>
                  <li>
                    <strong>Trittico</strong>: 3 mesi visibili, ideale uffici
                  </li>
                  <li>
                    <strong>Da scrivania</strong>: compatto e funzionale
                  </li>
                  <li>
                    <strong>Poster</strong>: 50x70 cm, visione annuale
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100">
                ...
                <ul className="space-y-2 text-gray-700 list-disc list-inside">
                  <li>
                    <strong>Marketing</strong>: logo e contatti sempre visibili
                  </li>
                  <li>
                    <strong>Regali clienti</strong>: pensiero utile e duraturo
                  </li>
                  <li>
                    <strong>Eventi</strong>: promozione manifestazioni annuali
                  </li>
                  <li>
                    <strong>Interno</strong>: pianificazione team e scadenze
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <p className="mt-6 text-gray-700">
                {/* PLACEHOLDER: Espandere con dettagli reali */}I calendari
                personalizzati sono il miglior investimento marketing a Roma:
                365 giorni di visibilità garantita. Forniamo tracciati di
                fustella per progettazione autonoma o servizio grafico completo.
                Ideali per aziende, studi professionali, associazioni e privati
                che vogliono un regalo unico.
              </p>
            </div>
          </div>
        </div>
      ...
      <Benefits
        benefits={calendariBenefits}
        sectionTitle="Il modo più efficace per promuovere il tuo brand a Roma tutto l'anno"
      />
      ...
      <FAQ
        faqs={calendariFaqs}
        sectionTitle="Info su grafiche, formati e tempi di consegna calendari"
      />
    </>
  );
}
