...
export const metadata = {
  ...
  description:
    "Personalizzazione tramite sublimazione per tazze, cuscini, mousepad e maglie sportive. Ideale per regali e promozioni. Spedizione in tutta Italia.",
  keywords:
    "stampa sublimazione, gadget personalizzati, abbigliamento tecnico, tazze personalizzate, Roma",
  ...
  openGraph: {
    title: "Stampa Sublimazione Roma - Gadget e Sport",
    description:
      "Personalizzazione tramite sublimazione per tazze, cuscini, calzini, mousepad e maglie sportive.",
...
export default function SublimationPage() {
  ...
  const serviceSchema = {
    ...
    description:
      "Personalizzazione tramite sublimazione per tazze, cuscini, calzini, mousepad e maglie sportive. Ideale per regali e promozioni.",
    provider: {
    ...
    image: {
      ...
      url: `${BASE_URL}/og-image-sublimazione.jpg`,
      caption:
        "Tazza personalizzata con stampa a sublimazione - DTF Italia Roma",
      width: 1200,
      height: 630,
    },
  };
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 pt-4 pb-2">
        <Breadcrumb items={BREADCRUMB_ITEMS["/stampa-sublimazione"]} />
      </div>
      ...
      <main id="prodotti-sublimazione" className="bg-gray-100 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600">
            Stiamo preparando il catalogo prodotti per la sublimazione a Roma.
          </p>
        </div>
      </main>

      <HowItWorks
        steps={sublimazioneSteps}
        sectionTitle="Come trasformiamo le tue idee in oggetti unici"
      />

      {/* Materiali e Specifiche - SEO Content */}
      <section
        className="py-16 bg-white"
        aria-labelledby="sublimazione-details"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2
              id="sublimazione-details"
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-violet-50 rounded-2xl p-6 border border-violet-100">
                ...
                <ul className="space-y-2 text-gray-700 list-disc list-inside">
                  <li>
                    <strong>Inchiostri sublimazione</strong>: colori brillanti e
                    duraturi
                  </li>
                  <li>
                    <strong>Carta transfer</strong>: alta definizione
                    fotografica
                  </li>
                  <li>
                    <strong>Supporti poliestere</strong>: tessuti tecnici 100%
                    poliestere
                  </li>
                  <li>
                    <strong>Rivestimenti speciali</strong>: ceramica, metallo,
                    plastica
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-50 rounded-2xl p-6 border border-violet-100">
                ...
                <ul className="space-y-2 text-gray-700 list-disc list-inside">
                  <li>
                    <strong>Gadget rigidi</strong>: tazze, mousepad, piastre
                  </li>
                  <li>
                    <strong>Abbigliamento tecnico</strong>: maglie sportive,
                    divise
                  </li>
                  <li>
                    <strong>Regali personalizzati</strong>: cuscini, coperte
                  </li>
                  <li>
                    <strong>Promozioni aziendali</strong>: gadget brandizzati
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <p className="mt-6 text-gray-700">
                ...
                La sublimazione è ideale per tessuti bianchi o chiari in
                poliestere. Il calore trasforma l'inchiostro in gas che penetra
                nelle fibre, creando stampe fotografiche permanenti e
                resistenti. Perfetta per abbigliamento sportivo e gadget
                promozionali a Roma.
              </p>
            </div>
          </div>
      ...
      <Benefits
        benefits={sublimazioneBenefits}
        sectionTitle="Massima resa cromatica per i tuoi gadget a Roma"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                Stampa professionale su abbigliamento
              </p>
            </a>
            <a
      ...
      <FAQ
        faqs={sublimazioneFaqs}
        sectionTitle="Domande comuni sulla personalizzazione sublimatica"
      />
    </>
  );
}
