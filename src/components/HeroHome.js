            ...
            {services.map((service, i) => {
              ...
              return (
                <a
                  key={i}
                  href={service.href}
                  className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 w-full h-20 hover:bg-white/20 hover:scale-105 transition-all group flex flex-col items-center justify-center gap-1"
                ...
                >
                  <Icon 
                    ...
                    aria-hidden="true"
                  />
                  <div className="text-white font-semibold text-base text-center">{service.name}</div>
                </a>
              );
            })}
          </div>
